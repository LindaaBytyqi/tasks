...
$max_price_sql = "SELECT MAX(COALESCE(sale_price, price)) as highest_price FROM products WHERE category_id = :category_id"; 
$max_price_stmt = $conn->prepare($max_price_sql); 
$max_price_stmt->execute(["category_id" => $category_id]); 
